...
#execute at @a[scores={Taunt=1..}] run execute as @e[type=!player,distance=..10] if entity @a[distance=..10,scores={Taunt=1}] run data modify entity @s AngerTime set value 20
